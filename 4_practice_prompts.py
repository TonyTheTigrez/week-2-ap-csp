...
object2 = "cable"
object3 = "mouse"
print(f"There is a {object1}, {object2},and {object3} all over")
...
print("Hi " + name + "! Your favorite color is " + favorite_color + ".")
